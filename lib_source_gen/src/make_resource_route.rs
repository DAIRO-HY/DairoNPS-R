...
/// 生成单个静态资源的路由代码块
/// root_dir 是静态资源的根目录， max_age 是 Cache-Control 的 max-age 值（单位秒）， file_path 是当前文件路径， is_out_dir 表示是否已经写入 OUT_DIR
fn make_route_item(root_dir: &str, max_age: u32, file_path: &Path, is_out_dir: bool) -> String {
...
/// Generated at [TIME]
/// 设置静态资源路由
fn set_html_routes(app: Router) -> Router {
