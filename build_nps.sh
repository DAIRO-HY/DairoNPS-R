...
mv ./target/release/DairoNPS ./DairoNPS-linux-amd64-$version
...
mv ./target/release/DairoNPS ./DairoNPS-linux-386-$version
...
mv ./target/release/DairoNPS ./DairoNPS-linux-arm64-$version
...
mv ./target/release/DairoNPS ./DairoNPS-linux-arm32-v7-$version


#编译到macOS intel平台
cargo clean
cargo build --release --package DairoNPS --target x86_64-apple-darwin
mv ./target/x86_64-apple-darwin/release/DairoNPS ./DairoNPS-mac-darwin-amd64-$version


#编译到macOS M平台
cargo clean
cargo build --release --package DairoNPS --target aarch64-apple-darwin
mv ./target/aarch64-apple-darwin/release/DairoNPS ./DairoNPS-mac-darwin-aarch64-$version