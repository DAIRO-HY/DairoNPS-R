    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/client_list.html">客户端</a>
                </li>
                <li class="nav-item">
...
<div id="restartDiv" class="alert alert-warning" role="alert" style="display:none;">
    <div class="d-flex">
        <div class="ps-2 flex-grow-1">配置已被修改，需要重启才会生效</div>
        <span role="button" onclick="onRestartClick()">立即重启</span>
    </div>
</div>
<div id="restartingDiv" class="alert alert-warning" role="alert" style="display:none;">
    服务正在重启中......
</div>
